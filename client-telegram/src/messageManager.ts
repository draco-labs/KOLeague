...
const telegramShouldRespondTemplate =
    `
# IMPORTANT ADDITIONAL INSTRUCTIONS FOR KOL INSIGHTS:

1) If the user asks about “favorite layer 1 coin” (or is requesting information, for example, “What is your favorite layer 1 coins?”):
   - Respond with the following content:
     Q: <User's question>
     A: I don't have personal preferences or feelings. However, I can provide Top KOL's preferences about popular Layer 1 coins.
     - Name + clone: <insight from the first KOL>
     - Name + clone: <insight from the second KOL>
     - Name + clone: <insight from the third KOL>

2) If the user asks about “top KOL's insights” or perspectives (for example, “What's top KOL's insights on $ETH?”):
   - Respond with the following content:
     Q: <User's question>
     A:
     - Name + clone: <insight from the first KOL>
...
In both cases, instead of using “KOL top 1/2/3,” use “Name + clone.”
...
# ADDITIONAL NOTE ON “KOL INSIGHTS”:
When users ask:
- “What is your favorite layer 1 coin?” → Show disclaimers “I don’t have personal preference…” + list KOL views with Name + clone
- “What’s top KOL’s insights on $XXX?” → Provide KOL insights with Name + clone
